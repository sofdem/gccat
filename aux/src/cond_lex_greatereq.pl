...
ctr_date(cond_lex_greatereq,['20060416']).

ctr_origin(cond_lex_greatereq, 'Inspired by \\cite{WallaceWilson06}.', []).

ctr_types(cond_lex_greatereq, ['TUPLE_OF_VALS'-collection(val-int)]).

ctr_arguments(cond_lex_greatereq,
              ['VECTOR1'-collection(var-dvar)                      ,
               'VECTOR2'-collection(var-dvar)                      ,
               'PREFERENCE_TABLE'-collection(tuple-'TUPLE_OF_VALS')]).

ctr_exchangeable(cond_lex_greatereq,
                 [items_sync('VECTOR1','VECTOR2','PREFERENCE_TABLE'^tuple,all),
                  vals(['VECTOR1','VECTOR2','PREFERENCE_TABLE'^tuple],int,=\=,all,dontcare)]).

ctr_restrictions(cond_lex_greatereq,
...
ctr_typical(cond_lex_greatereq,
            [size('TUPLE_OF_VALS')    > 1,
             size('VECTOR1')          > 1,
             size('VECTOR2')          > 1,
             size('PREFERENCE_TABLE') > 1]).

ctr_example(cond_lex_greatereq,
            cond_lex_greatereq([[var-0], [var-0]],
                               [[var-1], [var-0]],
                               [[tuple-[[val-1], [val-0]]],
                                [tuple-[[val-0], [val-1]]],
                                [tuple-[[val-0], [val-0]]],
...
ctr_see_also(cond_lex_greatereq,
 [link('implied by',     cond_lex_greater, '',   []),
...
ctr_key_words(cond_lex_greatereq,['order constraint'                ,
                                  'vector'                          ,
                                  'lexicographic order'             ,
                                  'preferences'                     ,
...
ctr_persons(cond_lex_greatereq,['Wallace R. J.',
                                'Wilson N.'    ]).

ctr_eval(cond_lex_greatereq, [automata(cond_lex_greatereq_a)]).

cond_lex_greatereq_a(VECTOR1, VECTOR2, PREFERENCE_TABLE) :-
